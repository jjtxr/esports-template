...
if(mysql_num_rows($mainsponsors)) {
	...
	while($da=mysql_fetch_array($mainsponsors)) {
		if(!empty($da['banner'])) $sponsor='<center><img src="images/sponsors/'.$da['banner'].'" style="width:620px;height:70px;margin:2px 0;" alt="'.htmlspecialchars($da['name']).'" title="'.htmlspecialchars($da['name']).'" /></center>';
