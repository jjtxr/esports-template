...
$maxscene					=	$ds['scene']; 				if(empty($maxscene)) $maxscene = 10;
$latestscene				=	$ds['latestscene']; 		if(empty($latestscene)) $latestscene = 6;
$scenechars					=	$ds['scenechars']; 			if(empty($scenechars)) $scenechars = 18;
