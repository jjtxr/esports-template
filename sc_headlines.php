...
$ergebnis=safe_query("SELECT * FROM ".PREFIX."news WHERE published='1' ".$only." AND intern<=".isclanmember($userID)." ORDER BY date DESC LIMIT 0,12");
if(mysql_num_rows($ergebnis)){
	...
	while($ds=mysql_fetch_array($ergebnis)) {
		...
		else $rubricipic = '<img src="'.$rubricipic.'" >';	
