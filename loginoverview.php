...
if($userID && !isset($_GET['userID']) && !isset($_POST['userID'])) {
  ...
  $topiclist="";
	if(mysql_num_rows($topics)) {
      ...
      <td>'.$_language->module['no_new_topics'].'</td>
    </tr>';
  ...
  if(mysql_num_rows($posts)) {
      ...
      $postlist.='<tr>
          ...
          <table width="100%" cellpadding="2" cellspacing="1">
            ...
            <tr>
              <td width="1%">&nbsp;</td>
              <td width="98%"><div style="overflow:hidden;">'.str_break(clearfromtags($message), 34).'</div></td>
              <td width="1%">&nbsp;</td>
            </tr>
          </table>
          </td>
      ...
      <td valign="top">'.$_language->module['no_new_posts'].'</td>
    </tr>';

	//clanmember/admin/referer
  
	if(isanyadmin($userID)) $admincenterpic = '<a href="admin/admincenter.php" target="_blank"><img src="images/icons/admincenter.gif" border="0" alt="Admincenter" /></a>';
	else $admincenterpic = '';
  
	if(isset($_SESSION['referer'])) {
		$referer_uri = '<tr><td><br /><a href="'.$_SESSION['referer'].'" style="padding:8px 0;"><b>&laquo; '.$_language->module['back_last_page'].'</b></a><br />&nbsp;</td></tr>';
