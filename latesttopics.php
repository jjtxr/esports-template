...
if($anz) {
	...
	while($ds=mysql_fetch_array($ergebnis)) {
        ...
        elseif ($ds['boardico_grp']=="4")   $boardico='<img src="images/forumico/'.$ds['boardico'].'.gif" alt="ICO" />';
        else                                $boardico='';
        ...
        while($de = mysql_fetch_assoc($gut)){
            ...
            elseif ($de['catico_grp']=="4")		$catico='<img src="images/forumico/'.$de['catico'].'.gif" alt="ICO" />';
            else                            	$catico='';
        }
