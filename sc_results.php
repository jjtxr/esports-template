...
if(mysql_num_rows($ergebnis)){
  ...
  while($ds=mysql_fetch_array($ergebnis)) {
    ...
    if($homescr>$oppscr) $result='<img src="slice/results/won.png" alt="" />';
		elseif($homescr<$oppscr) $result='<img src="slice/results/lose.png" alt="" />';
		else $result='<img src="slice/results/draw.png" alt="" />';
