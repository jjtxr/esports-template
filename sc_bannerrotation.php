...
if($total) {
	...
	echo '<a href="out.php?bannerID='.$banner['bannerID'].'" target="_blank"><img src="./images/bannerrotation/'.$banner['banner'].'" class="img" style="border: 5px solid #575757;" border="0" alt="'.htmlspecialchars($banner['bannername']).'" /></a>';
}
